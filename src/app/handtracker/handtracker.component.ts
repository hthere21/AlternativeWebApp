  ...
  runDetection(){
    if (this.model != null){
        let predictions = this.model.detect(this.video.nativeElement).then((predictions: any) => {
            ...
            //
            else if(openhands == 1 && closedhands == 1) this.detectedGesture = "Open and Closed Hands";
            else if(openhands == 1 && pointing == 1) this.detectedGesture = "Open and Pointing Hands";
            else if(openhands == 1 && pinching == 1) this.detectedGesture = "Open and Pinching Hands";
            else if(openhands == 1) this.detectedGesture = "Open Hand";
            
            //
            else if(closedhands == 1 && pointing == 1) this.detectedGesture = "Closed and Pointing Hands";
            else if(closedhands == 1 && pinching == 1) this.detectedGesture = "Closed and Pinching Hands";
            else if(closedhands == 1) this.detectedGesture = "Closed Hand";
           //
            else if(pointing == 1 && pinching ==1) this.detectedGesture = "Hand Pointing and Pinching";
